...
but you can adjust the parser for your setup.
...
You can also write your own parser. The current one is: includes/port-descr-parser.inc.php

When your own parser is created, you can enable it with:
