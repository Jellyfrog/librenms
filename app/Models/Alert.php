...
#[QueryParameter(key: 'rule_id', filter: EqualsFilter::class)]
#[QueryParameter(key: 'state', filter: EqualsFilter::class)]
#[QueryParameter(key: 'severity', filter: EqualsFilter::class)]
#[QueryParameter(key: 'sort[:property]', filter: OrderFilter::class, properties: ['id', 'device_id', 'rule_id', 'state', 'timestamp'])]
