...
#[ApiProperty(property: 'device_id')]
...
// As on Device, relations to another resource are turned off. device_id plus
// /devices/{device_id}/ports is the link back to the device; the port to port
// links are topology the API does not model yet.
#[ApiProperty(property: 'device', readable: false)]
#[ApiProperty(property: 'xdp_linked_ports', readable: false)]
#[ApiProperty(property: 'mac_linked_ports', readable: false)]
#[ApiProperty(property: 'pagp_parent', readable: false)]
#[ApiProperty(property: 'stack_children', readable: false)]
#[ApiProperty(property: 'stack_parent', readable: false)]
