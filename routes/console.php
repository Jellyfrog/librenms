...
use App\Console\Commands\MaintenanceCleanupRrd;
...
Schedule::command(MaintenanceCleanupRrd::class)
    ->dailyAt(Time::pseudoRandomBetween('15:00', '15:59'))
    ->onOneServer()
    ->appendOutputTo($maintenance_log_file)
    ->onFailure(fn () => Eventlog::log('The scheduled command maintenance:cleanup-rrd failed to run. Check the maintenance.log for details.', null, 'maintenance', Severity::Error));
