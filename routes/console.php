...
use App\Console\Commands\MaintenanceCleanupPorts;
...
Schedule::command(MaintenanceCleanupPorts::class)
    ->dailyAt(Time::pseudoRandomBetween('13:00', '13:59'))
    ->onOneServer()
    ->appendOutputTo($maintenance_log_file)
    ->onFailure(fn () => Eventlog::log('The scheduled command maintenance:cleanup-ports failed to run. Check the maintenance.log for details.', null, 'maintenance', Severity::Error));
