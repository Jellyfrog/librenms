...
use App\Console\Commands\MaintenanceCleanupRoute;
...
Schedule::command(MaintenanceCleanupRoute::class)
    ->dailyAt(Time::pseudoRandomBetween('10:00', '10:59'))
    ->onOneServer()
    ->appendOutputTo($maintenance_log_file)
    ->onFailure(fn () => Eventlog::log('The scheduled command maintenance:cleanup-route failed to run. Check the maintenance.log for details.', null, 'maintenance', Severity::Error));
