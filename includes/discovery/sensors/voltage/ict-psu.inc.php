...
$inputVoltage = trim(SnmpQuery::mibs(['ICT-PLATINUM-MIB'])->get('inputVoltage.0')->value(), '" ');
...
$outputVoltage = trim(SnmpQuery::mibs(['ICT-PLATINUM-MIB'])->get('outputVoltage.0')->value(), '" ');
