...
return [
    ...
    */
    ...
    'redis' => [
        ...
        'polling' => [
            'scheme' => env('REDIS_POLLING_SCHEME', env('REDIS_SCHEME', 'tcp')),
            'url' => env('REDIS_POLLING_URL', env('REDIS_URL')),
            'host' => env('REDIS_POLLING_HOST', env('REDIS_HOST', '127.0.0.1')),
            'password' => env('REDIS_POLLING_PASSWORD', env('REDIS_PASSWORD', null)),
            'port' => env('REDIS_POLLING_PORT', env('REDIS_PORT', '6379')),
            'database' => env('REDIS_POLLING_DB', env('REDIS_DB', '0')),
        ],        
